...
def single_img_features(img, color_space='RGB', spatial_size=(32, 32),
    ...
    if spatial_feat == True:
        # we got best results with color space HLS
        spatial_features_image = cv2.cvtColor(img, cv2.COLOR_RGB2HLS)
        spatial_features = bin_spatial(spatial_features_image, size=spatial_size)
